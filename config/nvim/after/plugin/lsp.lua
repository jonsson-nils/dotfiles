...
local on_attach = function(_, bufnr)
  ...
  vim.keymap.set("n", "gt", function() vim.cmd [[Telescope lsp_type_definitions]] end, nopts)
  vim.keymap.set("n", "gd", function() vim.cmd [[Telescope lsp_definitions]] end, nopts)
  vim.keymap.set("n", "gi", function() vim.cmd [[Telescope lsp_implementations]] end, nopts)
  vim.keymap.set("n", "gr", function() vim.cmd [[Telescope lsp_references]] end, nopts)
  ...
  vim.keymap.set("n", "<leader>.s", function() vim.cmd [[Telescope lsp_workspace_symbols]] end, nopts)
