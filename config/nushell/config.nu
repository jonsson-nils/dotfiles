...
module git_completions {
  ...
  def "nu-complete git branches" [] {
    ^git branch | lines | each { |line| $line | str replace -r '[\*\+] ' '' -n | str trim }
  }
...
module home_manager_completions {
  ...
  export extern "home-manager build" []
  export extern "home-manager init" [
    --switch
    directory?: string
  ]
  ...
  export extern "home-manager packages" []
